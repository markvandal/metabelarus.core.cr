...
# Set Up metabelaruscorecr
chmod +x /usr/bin/metabelaruscorecrd /usr/bin/metabelaruscorecrcli
mkdir -p /metabelaruscorecr/config
systemctl enable metabelaruscorecrd
