...
const (
	...
	RecordType_PROVIDER_RECORD          RecordType = 1
	RecordType_PROVIDER_SIGNABLE_RECORD RecordType = 2
	RecordType_PROVIDER_PERMISSION      RecordType = 3
)

var RecordType_name = map[int32]string{
	0: "IDENTITY_RECORD",
	1: "PROVIDER_RECORD",
	2: "PROVIDER_SIGNABLE_RECORD",
	3: "PROVIDER_PERMISSION",
}
...
type MsgCreateRecord struct {
	...
	CreationDt *time.Time    `protobuf:"bytes,9,opt,name=creationDt,proto3,stdtime" json:"creationDt,omitempty"`
}
...
var fileDescriptor_a4427976c2c647fa = []byte{
	...
	,
}
