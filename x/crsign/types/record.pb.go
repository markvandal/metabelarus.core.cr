...
const (
	...
	RecordType_IDENTITY_MUTUAL_RECORD   RecordType = 1
	RecordType_PROVIDER_RECORD          RecordType = 2
	RecordType_PROVIDER_SIGNABLE_RECORD RecordType = 3
	RecordType_PROVIDER_MUTUAL_RECORD   RecordType = 4
	RecordType_PROVIDER_PERMISSION      RecordType = 5
)

var RecordType_name = map[int32]string{
	0: "IDENTITY_RECORD",
	1: "IDENTITY_MUTUAL_RECORD",
	2: "PROVIDER_RECORD",
	3: "PROVIDER_SIGNABLE_RECORD",
	4: "PROVIDER_MUTUAL_RECORD",
	5: "PROVIDER_PERMISSION",
}

var RecordType_value = map[string]int32{
	"IDENTITY_RECORD":          0,
	"IDENTITY_MUTUAL_RECORD":   1,
	"PROVIDER_RECORD":          2,
...
type Id2KeyRecord struct {
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
}

func (m *Id2KeyRecord) Reset()         { *m = Id2KeyRecord{} }
func (m *Id2KeyRecord) String() string { return proto.CompactTextString(m) }
func (*Id2KeyRecord) ProtoMessage()    {}
func (*Id2KeyRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_a4427976c2c647fa, []int{5}
}
func (m *Id2KeyRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Id2KeyRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Id2KeyRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Id2KeyRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Id2KeyRecord.Merge(m, src)
}
func (m *Id2KeyRecord) XXX_Size() int {
	return m.Size()
}
func (m *Id2KeyRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_Id2KeyRecord.DiscardUnknown(m)
}

var xxx_messageInfo_Id2KeyRecord proto.InternalMessageInfo

func (m *Id2KeyRecord) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*Id2KeyRecord)(nil), "metabelarus.mbcorecr.crsign.Id2KeyRecord")
}
...
var fileDescriptor_a4427976c2c647fa = []byte{
	...
	,
}
...
func (m *Id2KeyRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Id2KeyRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Id2KeyRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Id2KeyRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Id2KeyRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Id2KeyRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Id2KeyRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
