...
func registerQueryRoutes(clientCtx client.Context, r *mux.Router) {
	...
	r.HandleFunc("/crsign/signatureLists/{id}", getSignatureListHandler(clientCtx)).Methods("GET")
	r.HandleFunc("/crsign/signatureLists", listSignatureListHandler(clientCtx)).Methods("GET")
...
func registerTxHandlers(clientCtx client.Context, r *mux.Router) {
	...
	r.HandleFunc("/crsign/signatureLists", createSignatureListHandler(clientCtx)).Methods("POST")
	r.HandleFunc("/crsign/signatureLists/{id}", updateSignatureListHandler(clientCtx)).Methods("POST")
