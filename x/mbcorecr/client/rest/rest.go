...
func registerTxHandlers(clientCtx client.Context, r *mux.Router) {
    ...
    r.HandleFunc("/mbcorecr/invites/{id}", updateInviteHandler(clientCtx)).Methods("POST")
    r.HandleFunc("/mbcorecr/invites/{id}", deleteInviteHandler(clientCtx)).Methods("POST")
